...
export const PROXY_BASE_URL = "http://100.64.80.236:8080"; // TODO à remplir avec l'URL du proxy d'Ambroise au moment où il sera lancé sur un pc de la salle on ne sait pas l'IP à l'avance
